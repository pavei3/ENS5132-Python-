# -*- coding: utf-8 -*-
"""
Created on Tue May  6 11:22:31 2025
...
colunas_necessarias = ['cod_produto', 'num_ano', 'volume_hl']
...
# =============================================
dados_grafico = df.groupby(['num_ano', 'tipo_bebida'])['volume_hl'].sum().unstack()
...
plt.title('Soma Anual de Produção Tipo de Bebida (Escala Log)', fontsize=16, pad=20)
plt.xlabel('Ano', fontsize=14)
plt.ylabel('Produção (hL) - Soma (log)', fontsize=14)
...
plt.tight_layout()
plt.savefig('soma_anual_produção_log_tipos_bebida.png', dpi=300, bbox_inches='tight')
plt.show()
