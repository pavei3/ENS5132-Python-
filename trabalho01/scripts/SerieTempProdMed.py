# -*- coding: utf-8 -*-
"""
Created on Tue May  6 10:16:18 2025
...
dados_grafico = df.groupby(['num_ano', 'tipo_bebida'])['volume_hl'].mean().unstack()
...
plt.title('Evolução das Produções Médias por Tipo de Bebida', fontsize=16, pad=20)
plt.xlabel('Ano', fontsize=14)
plt.ylabel('Produção de Bebida (hL) - Média', fontsize=14)
